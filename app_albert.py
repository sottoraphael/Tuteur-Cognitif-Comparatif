            ...
            with st.chat_message("assistant"):
                ...
                try:
                    with st.spinner("L'IA réfléchit (Analyse et Mémoire en cours)..."):
                        ...
                        hist[0]["content"] += "\n\n<directive_interne>FORMAT STRICT : Tu DOIS répondre EXCLUSIVEMENT sous la forme d'un objet JSON contenant les 6 clés suivantes : 'diagnostic_interne', 'lettre_attendue_qcm', 'concept_actuel_evalue', 'liste_concepts_restants_du_cours' (format texte simple, pas de tableau), 'strategie_choisie', et 'reponse_visible'.</directive_interne>"
